; ModuleID = '/root/dora-mapper/benchmarks/test.c'
source_filename = "/root/dora-mapper/benchmarks/test.c"
target datalayout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-i128:128-f80:128-n8:16:32:64-S128"
target triple = "x86_64-pc-linux-gnu"

@.str = private unnamed_addr constant [12 x i8] c"total = %d\0A\00", align 1
@.str.1 = private unnamed_addr constant [18 x i8] c"small total = %d\0A\00", align 1
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @sum_up_to(i32 noundef %0) #0 {
...
define dso_local i32 @main() #0 {
  ...
  %10 = call i32 @sum_up_to(i32 noundef %9)
